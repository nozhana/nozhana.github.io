...
Download the PDF version of my resumé below instead of reading this.

{{< button text="Nozhan Amiri.pdf" url="/files/Nozhan Amiri.pdf" icon="file-text" size="m" variant="outline" />}}

## Experience

### Primary iOS Engineer — Taaghche

<span style="color:#9e9e9e">
Dec 2025 – Present | Tehran, Iran (On-site)
</span>
...
**Tech stack:**
Swift, Objective-C, UIKit, Realm, SQLite, URLSession, Alamofire, RxSwift, RAC, AppMetrica, WebEngage

### iOS Engineer — GCo Apps

<span style="color:#9e9e9e">
Oct 2024 – Nov 2025 | Tehran, Iran (On-site)
</span>
...
**Tech stack:**
Swift, SwiftUI, SwiftData, Metal, GPUImage, Instruments, Firebase

### iOS Engineer — Luminatech

<span style="color:#9e9e9e">
Jun 2022 – Oct 2024 | Lisbon, Portugal (Remote)
</span>
...
**Tech stack:**
Swift, UIKit, Alamofire, CoreData, Vision, Firebase, FB Marketplace, Google Analytics

## Education

### A.Sc. Software Engineering — University of Kashan

<span style="color:#9e9e9e">
2015 – 2019 | Kashan, Iran
</span>

Computer Engineering – Software

### High school diploma — Shahid Ejei (NODET)

<span style="color:#9e9e9e">
2011 – 2015 | Isfahan, Iran
</span>
...
Feb 2024 | Meta – Coursera

<a href="https://www.coursera.org/account/accomplishments/verify/DXCSHKETM6S8">View Certification</a>

## Spoken languages

- Persian | _Native_
- English | _Fluent (C2)_
- German | _Professional working proficiency (B2)_
